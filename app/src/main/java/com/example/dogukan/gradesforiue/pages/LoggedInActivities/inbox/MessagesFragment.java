...
public class MessagesFragment extends Fragment {
    ...
    {
        mInbox.setTextColor(getResources().getColor(R.color.colorAccent));

        mOutbox.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EventBus.getDefault().post(new MessaegePageSwitchedEvent("outbox"));
            }
        });
    ...
    {
        RestClient.getService().getMessages(page,sender,subject,message).enqueue(new Callback<ResponseBody>() {
            @Override
